            ...
            <nav>
                ...
                <div id="currencies-block-top">
                    <form id="setCurrency" action="" method="post">
                        <div class="current">
                            <span class="cur-label"></span> <strong>{{$currency[0]->short_code}}</strong></div>
                        ...
                        <ul>
                            ...
                            <li class="root root-7">
                                ...
                                @if($ct->layout==1 || $ct->layout==3)
                                    ...
                                    @endif
                                @elseif($ct->layout==2)
                                    @if(!empty(MenuPageController::showSubCategory($ct->id)))
                                    <ul class="menu-items col-md-3 col-xs-12">
                                        <li class="menu-item menu-item-19 depth-1 category menucol-1-4 ">
                                            <div class="title title_font" style="width: 200px;"> <a href="javascript:void(0);"> Available Sub Category </a></div>
                                            <ul class="submenu submenu-depth-2 col-md-12" style="width: 150px;">
                                                @foreach(MenuPageController::showSubCategory($ct->id) as $sc)
                                                <li class="menu-item menu-item-27 depth-2 category ">
                                                    <div class="title"> <a href="{{url('product/sub/'.$ct->id.'/'.$sc->id.'/'.$sc->name)}}"> {{$sc->name}} </a></div>
                                                </li>
                                                @endforeach
                        ...
                        <div class="block_content">
                            <div class="cart_block_list" id="shopping_cart_mini_detail">
                                ...
                                <dl class="products" id="cartProductsMini">
                                    ...
                                    @if(count(MenuPageController::shoppingCart()['products'])!=0)
                                        <?php $incre=0; ?>
                                ...
                                <div class="cart-prices">
                                    ...
                                    <div class="cart-prices-line last-line"> 
                                        <span class="price cart_block_total ajax_block_cart_total">$<b id="totalPrice">{{MenuPageController::shoppingCart()['totalPrice']}}</b></span> 
                                        <span>Total</span>
                                    </div>
                                </div>
                    ...
                    <form method="post" action="{{url('search')}}" id="searchbox">
                        <div class="input-group-btn search_filter form-group">
                            <select name="category_filter" id="category_filter" class="form-control">
                                ...
                                <option value="S{{$sc->id}}"> ------  {{$sc->name}}</option>
                                @endforeach
                                @endforeach
                            </select>
                        </div>
